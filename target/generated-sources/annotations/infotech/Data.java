...
public final class Data implements Cloneable {
  ...
  public java.util.List<java.lang.String> getWords() {
    ...
    try {
      proto.acquireLock();
      return infotech.DataModel.words(arg1);
    } finally {
      proto.releaseLock();
    }
  }
  ...
  public Data(java.lang.String message, boolean rotating) {
    this(net.java.html.BrwsrCtx.findDefault(Data.class));
    this.prop_message = message;
    this.prop_rotating = rotating;
  };
  private static class Html4JavaType extends org.apidesign.html.json.spi.Proto.Type<Data> {
    ...
    @Override public void call(Data model, int type, Object data, Object ev) throws Exception {
      switch (type) {
        case 0:
          infotech.DataModel.turnAnimationOn(model);
          return;
        case 1:
          infotech.DataModel.turnAnimationOff(model);
          return;
        case 2:
          infotech.DataModel.rotate5s(model);
          return;
        case 3:
          infotech.DataModel.showScreenSize(model);
          return;
      }
      throw new UnsupportedOperationException();
    }
